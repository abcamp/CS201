...
ggplot(data = average_species_flipper_length, aes(x = species, y = average_flipper_length_mm, fill = species)) +
  geom_bar(stat = "identity") +
  geom_errorbar(aes(ymin=average_flipper_length_mm-average_flipper_length_sd, ymax=average_flipper_length_mm+average_flipper_length_sd), width=0.25, colour="orange", alpha=0.75, size=0.5) + # just for fun
  theme_bw() +
...
plot_average_species_flipper_length <- ggplot(data = average_species_flipper_length, aes(x = species, y = average_flipper_length_mm, fill = species)) +
  geom_bar(stat = "identity") +
  geom_errorbar(aes(ymin=average_flipper_length_mm-average_flipper_length_sd, ymax=average_flipper_length_mm+average_flipper_length_sd), width=0.25, colour="orange", alpha=0.75, size=0.5) +
  theme_bw() +
  scale_x_discrete(labels=c('Adelie', 'Chinstrap', 'Gentoo')) +
  xlab("Penguin Species") +
  ylab("Average Flipper Length (mm)") +
...
plot_average_species_culmen_depth <- ggplot(data = average_species_culmen_depth, aes(x = species, y = average_culmen_depth_mm, fill = species)) +
  geom_bar(stat = "identity") +
  geom_errorbar(aes(ymin=average_culmen_depth_mm-average_culmen_depth_sd, ymax=average_culmen_depth_mm+average_culmen_depth_sd), width=0.25, colour="orange", alpha=0.75, size=0.5) + # just for fun
  theme_bw() +
  scale_x_discrete(labels=c('Adelie', 'Chinstrap', 'Gentoo')) +
  xlab("Penguin Species") +
